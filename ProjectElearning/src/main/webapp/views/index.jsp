...
<body>
				...
				<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
					<div class="service-item text-center pt-3">
						<div class="p-4">
							...
							<p>Our instructors are industry leaders and subject matter
								experts with years of experience in their fields.Learn at your
								own pace, anytime, anywhere.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
					<div class="service-item text-center pt-3">
						<div class="p-4">
							...
							<p>Benefit from video lessons, downloadable materials, and
								quizzes. Participate in live sessions, interactive discussions,
								and hands-on assignments. Access classes anytime, anywhere, and
								at your own pace.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
					<div class="service-item text-center pt-3">
						<div class="p-4">
							...
							<p>Revitalize your home and unleash your creativity with
								inspiring home projects that are as functional as they are
								stylish.Save money while upgrading your home.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
					<div class="service-item text-center pt-3">
						<div class="p-4">
							...
							<p>Step into a world of endless stories, knowledge, and
								imagination. Our library is your gateway to explore diverse
								genres, discover new authors, and indulge in the joy of reading.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row g-5">
				<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s"
					...
					<div class="position-relative h-100">
						<img class="img-fluid position-absolute w-100 h-100"
							src="/views/img/about.jpg" alt="" style="object-fit: cover;">
					</div>
				</div>
				<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
					...
					<p class="mb-4">Explore a vast collection of courses across
						various disciplines, including technology, business, arts,
						personal development, and more.</p>
					<p class="mb-4">Learn from industry leaders, certified
						educators, and subject matter experts who bring real-world
						insights to every lesson.</p>
					<p class="mb-4">Learn at your own pace, anytime, anywhere, with
						mobile-friendly content and downloadable materials.Earn
						certificates of completion to showcase your skills and enhance
						your resume or portfolio.</p>
					<div class="row gy-2 gx-4 mb-4">
						...
						<div class="col-sm-6">
							<p class="mb-0">
								<i class="fa fa-arrow-right text-primary me-2"></i>Virtual Labs
								and Simulations
							</p>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<p class="mb-0">
								<i class="fa fa-arrow-right text-primary me-2"></i> Interactive
								Learning Experience
							</p>
						</div>
						<div class="col-sm-6">
							<p class="mb-0">
								<i class="fa fa-arrow-right text-primary me-2"></i>Certification
							</p>
						</div>
					</div>
					<a class="btn btn-primary py-3 px-5 mt-2" href="about">Read
						More</a>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
					<div class="course-item bg-light">
						...
						<div class="text-center p-4 pb-0">
							...
							<h5 class="mb-4">Java FullStack Course for Beginners</h5>
						</div>
						<div class="d-flex border-top">
							<small class="flex-fill text-center border-end py-2"><i
								class="fa fa-user-tie text-primary me-2"></i>John Doe</small> <small
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
					<div class="course-item bg-light">
						...
						<div class="text-center p-4 pb-0">
							...
							<h5 class="mb-4">REACT and PYTHON Course for Beginners</h5>
						</div>
						<div class="d-flex border-top">
							<small class="flex-fill text-center border-end py-2"><i
								class="fa fa-user-tie text-primary me-2"></i>John Doe</small> <small
	...
	<div class="text-center p-12 pb-0">
	<a class="btn btn-primary py-3 px-5 mt-2" href="/user/courses">Read
		More</a>
	</div>
	</div>
	</div>
			...
			<div class="row g-4">
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
					<div class="team-item bg-light">
						<div class="overflow-hidden">
							<img class="img-fluid" src="/views/img/team-1.jpg" alt="">
						</div>
						...
						<div class="text-center p-4">
							<h5 class="mb-0">Libin Thomas</h5>
							<small>Science Expert</small>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
					<div class="team-item bg-light">
						...
						<div class="text-center p-4">
							<h5 class="mb-0">Dinesh Jatav</h5>
							<small>Maths & Physics Expert</small>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
					<div class="team-item bg-light">
						...
						<div class="text-center p-4">
							<h5 class="mb-0">Neeraj Gadhvi</h5>
							<small>Maths Expert</small>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
					<div class="team-item bg-light">
						<div class="overflow-hidden">
							<img class="img-fluid" src="/views/img/team-4.jpg" alt="">
						</div>
						<div class="position-relative d-flex justify-content-center"
							style="margin-top: -23px;">
							<div class="bg-light d-flex justify-content-center pt-2 px-1">
						...
						<div class="text-center p-4">
							<h5 class="mb-0">Savita Rani Sadh</h5>
